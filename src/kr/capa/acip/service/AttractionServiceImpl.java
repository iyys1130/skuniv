...
public class AttractionServiceImpl implements AttractionService {
	...
	public List<AttractionVO> Waittime(int lnum) {
		// TODO Auto-generated method stub
		return attractiondao.waittime(lnum);
	}

	@Override
	public int Congestion(int lnum) {
		// TODO Auto-generated method stub
		int totalwaittime=attractiondao.totalwaittime(lnum);
		System.out.println(totalwaittime);
		int totalattraction=attractiondao.totalattraction(lnum);
		System.out.println(totalattraction);
		int congestion=totalwaittime/totalattraction;
		return congestion;
	}
