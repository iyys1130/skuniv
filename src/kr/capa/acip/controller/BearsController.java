...
public class BearsController {
	...
	public String waittime(Model model) {
		model.addAttribute("waittime",attractionservice.Waittime(1));
	...
	// 추천코스 선택 연결 컨트롤러
	   ...
	   @RequestMapping("1ajax")
	    public String ajax(){
		   return "1bears/1realtime/1ajax";
	   }
}