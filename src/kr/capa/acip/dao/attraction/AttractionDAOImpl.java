...
public class AttractionDAOImpl implements AttractionDAO {
	...
	@Override
	public List<AttractionVO> waittime(int lnum) throws RuntimeException {
		// TODO Auto-generated method stub
		return sqlSession.selectList("kr.capa.acip.Attraction.waittime", lnum);
	}

	@Override
	public int totalwaittime(int lnum) throws RuntimeException {
		// TODO Auto-generated method stub
		return (int)sqlSession.selectOne("kr.capa.acip.Attraction.totalwaittime", lnum);
	}
	
	@Override
	public int totalattraction(int lnum) throws RuntimeException {
		// TODO Auto-generated method stub
		return (int)sqlSession.selectOne("kr.capa.acip.Attraction.totalattraction", lnum);
	}
}
